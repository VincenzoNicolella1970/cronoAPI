...
$redirect_uri = 'https://parrocchiasgibattista.it/cronoWAP/oauthwp';
...
$wp_base = 'https://www.parrocchiasgibattista.it/site';
 ...
 */
function fetchWpRolesHmac(string $rolesEndpoint, int $userId, string $secret): array
{
  if ($userId <= 0 || $secret === '') {
...
$rolesResp = fetchWpRolesHmac($roles_endpoint, $userId, $roles_secret);
